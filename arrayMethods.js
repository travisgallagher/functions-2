...
Instead of just arrays of numbers, 
we are going to have array of objects that we want to use map, filter, 
and reduce with.
...
// KG explained; 
//const myStrongest = monstersInYourPocket.filter((singleObjectMonster) => singleObjectMonster.CP > 200)
// let arrayBeingFiltered = [
//   {"name":"keaton", "age":28},
//   {"name":"Travis", "age":27}
// ];
// const filterExplained = arrayBeingFiltered.filter((eachObject) => {
//     // Condition
...
const bobsTotal = purchases.filter(purchase => purchase.owner === "Bob" ).reduce((i, elem) => i + elem.price, 0); 